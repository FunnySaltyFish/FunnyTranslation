...
public class TranslationTask
{
	...
	public void translate(){
		...
		switch(engineKind){
			...
			case Consts.ENGINE_BAIDU_NORMAL:
				...
				break;
			case Consts.ENGINE_GOOGLE:
				this.resultString=translateGoogleEasy(sourceString);
				break;
		}
	...
	public String translateGoogleEasy(String sourceString){
			PrintWriter out = null;
			BufferedReader in = null;
			String result = "";
			try {
				...
				result=FunnyGoogleApi.formatResultGoogleComplex(result).getBasicResult();
			} catch (Exception e) {
				System.out.println("发送 POST 请求出现异常！"+e);
				e.printStackTrace();
				result=("发送 POST 请求出现异常！"+e);
	...
	public void translateGoogleEasy(){
		...
		*/
		/*谷歌tts
		https://translate.google.cn/translate_tts?ie=UTF-8&q=%s&tl=en&total=1&idx=0&textlen=78&tk=91195.512248&client=webapp
		*/
	}
